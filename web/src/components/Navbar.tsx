      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 sm:gap-4 text-xs font-bold uppercase tracking-wider">
          <Link 
            ...
            activeProps={{ className: '!text-[#00f5ff] bg-slate-950 border border-slate-800 shadow-[0_0_10px_rgba(0,245,255,0.1)]' }}
          >
            Home
          </Link>
          ...
          {isLoading ? (
            <span className="text-[10px] tracking-widest text-[#ff007f] animate-pulse px-4">// SYNCING_NODE</span>
          ) : isAuthenticated ? (
